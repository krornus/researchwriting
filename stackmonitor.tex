...
The overall workflow of our vulnerability detection toolkit is shown in Figure\ref{fig-workflow} 
and includes ?? main components: component 1, which does ??? ; component  2, which does ???, etc.
the binary debugger, which takes the executable code of a user program,...
The debugger will call functions within
